      ...
      <div className="bg-card dark:bg-slate-800 rounded-3xl shadow-modal w-full max-w-md p-6 relative animate-fade-in-up">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="px-3 py-2 text-sm bg-card dark:bg-slate-700 border border-border dark:border-primary/30 rounded-lg hover:bg-primary/10 dark:hover:bg-primary/10 transition-all duration-300 text-text-primary dark:text-slate-100"
            >
              1 hour ago
            </button>
            <button
        ...
        <div className="mb-4">
          <label className="flex items-center text-sm font-medium text-text-primary dark:text-slate-100 mb-2">
            <CalendarIcon className="w-5 h-5 mr-2 text-primary dark:text-primary" />
            Date
          </label>
          <input
            type="date"
            ...
            className="w-full px-4 py-3 border border-border dark:border-primary/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-primary bg-card dark:bg-slate-700 text-text-primary dark:text-slate-100"
          />
        </div>
        ...
        <div className="mb-6">
          <label className="flex items-center text-sm font-medium text-text-primary dark:text-slate-100 mb-2">
            <ClockIcon className="w-5 h-5 mr-2 text-primary dark:text-primary" />
            Time
          </label>
          <input
            type="time"
        ...
        {/* Preview */}
        <div className="mb-6 p-3 bg-primary/5 dark:bg-primary/10 rounded-2xl border border-primary/20 dark:border-primary/20">
        ...
        <button
          ...
          className="w-full bg-gradient-to-br from-primary to-primary-dark dark:from-primary dark:to-primary text-white font-semibold py-3 rounded-lg hover:shadow-fab transition-all duration-300"
        >
          Continue
        </button>
      </div>
