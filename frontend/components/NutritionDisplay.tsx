    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {items.map((item, index) => (
          <div key={index} className="bg-card border-2 border-border rounded-2xl p-3 shadow-card">
      ...
      <div className="bg-primary/5 border-2 border-primary/30 rounded-2xl p-4 shadow-card">
        ...
        <div className="grid grid-cols-4 gap-3 mt-4">
          <div className="bg-card rounded-lg p-3 text-center shadow-card border-2 border-primary/10">
