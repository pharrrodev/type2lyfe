...
export const ForkSpoonIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M2 22v-5l5-5-5-5V2h20v20h-2v-3h-2v3h-2v-3h-2v3H8v-3H6v3H4v-3H2Z"/>
        <path d="M12 11V2"/>
        <path d="M16 6V2"/>
        <path d="M8 6V2"/>
    </svg>
...
export const WeightScaleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M4 4h16v2a6 6 0 0 1-6 6H10a6 6 0 0 1-6-6V4Z"/>
...
export const BloodPressureIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 8V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v1" />
        <path d="M12 12v4h4" />
        <path d="M12 12h-4" />
        <path d="M6 12H4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h2" />
        <path d="M18 12h2a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-2" />
        <path d="m14 16.5 3-3-1.5-1.5-3 3-1.5-1.5-3 3L9.5 18l3-3 1.5 1.5Z" />
    </svg>
);
